...
export const months = [
  { name: 'January', code: 'Jan', num: 1 },
  { name: 'February', code: 'Feb', num: 2 },
  { name: 'March', code: 'Mar', num: 3 },
  { name: 'April', code: 'Apr', num: 4 },
  { name: 'May', code: 'May', num: 5 },
  { name: 'June', code: 'Jun', num: 6 },
  { name: 'July', code: 'Jul', num: 7 },
  { name: 'August', code: 'Aug', num: 8 },
  { name: 'September', code: 'Sep', num: 9 },
  { name: 'October', code: 'Oct', num: 10 },
  { name: 'November', code: 'Nov', num: 11 },
  { name: 'December', code: 'Dec', num: 12 },
];
